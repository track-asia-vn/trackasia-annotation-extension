...
/**
 An `MLNSymbolAnnotationController` is a controller that creates internally
 instances of an `MLNShapeSource` and `MLNSymbolStyleLayer` to simplify the creation
 of runtime styling based annotations to the map.
 
 Create instances of `MLNSymbolStyleAnnotation` and pass it to this controller.
 ...
 ```
 */
@interface MLNSymbolAnnotationController : MLNAnnotationController
...
/**
 The orientation of the style annotation's icon when map is pitched, as defined by `MLNIconPitchAlignment`. 
 ...
 */
@property (nonatomic, assign) MLNIconPitchAlignment iconPitchAlignment;

/**
 Determines the rotation behavior of icons, in combination with `symbolPlacement` as defined by `MLNIconRotationAlignment`.
 Requires `iconImageName`. Defaults to `auto`.
 ...
 */
@property (nonatomic, assign) MLNIconRotationAlignment iconRotationAlignment;

/**
 Scales the icon to fit around the associated text, as defined by `MLNIconTextFit`. 
 ...
 */
@property (nonatomic, assign) MLNIconTextFit iconTextFit;
...
/**
 The placement of the symbol annotation's text relative to its geometry, as defined by `MLNSymbolPlacement`.
 Defaults to `point`.
 ...
 */
@property (nonatomic, assign) MLNSymbolPlacement symbolPlacement;
...
/**
 ...
 `MLNSymbolAnnotationController` are rendered, as defined by `MLNSymbolZOrder`. Defaults to `auto`.
 ...
 */
@property (nonatomic, assign) MLNSymbolZOrder symbolZOrder;
...
/**
 ...
 as defined by `MLNTextPitchAlignment`. Requires `text`. Defaults to `auto`.
 ...
 */
@property (nonatomic, assign) MLNTextPitchAlignment textPitchAlignment;

/**
 Determines the rotation behavior of the individual glyphs forming the text, in combination with `symbolPlacement` 
 and defined by `MLNTextRotationAlignment`. Requires `text`. Defaults to `auto`.
 ...
 */
@property (nonatomic, assign) MLNTextRotationAlignment textRotationAlignment;

/**
 Determines the best placement for the text of multiple symbol style annotations given an array of 
 preferred `MLNTextAnchor` values. This allows the renderer to auto-select a unique `textAnchor` 
...
/**
 Controls the frame of reference for `iconTranslation`, as defined by `MLNIconTranslationAnchor`.
 ...
 */
@property (nonatomic, assign) MLNIconTranslationAnchor iconTranslationAnchor;
...
/**
 Controls the frame of reference for `textTranslation`, as defined by `MLNTextTranslationAnchor`.
 ...
 */
@property (nonatomic, assign) MLNTextTranslationAnchor textTranslationAnchor;
