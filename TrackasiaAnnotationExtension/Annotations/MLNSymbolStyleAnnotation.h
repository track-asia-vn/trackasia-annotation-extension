...
/**
 An `MLNSymbolStyleAnnotation` is a type of style layer annotation that renders both an icon
 ...
 style annotation object. Then, use `-[MLNSymbolAnnotationController add:]` to add the annotation
 to a symbol style annotation controller.
 
 If rendering an icon, first add an image to the map style's sprite using
 the `-[MLNStyle setImage:forName:]` method within the [Mapbox Maps SDK for iOS](https://docs.mapbox.com/ios/api/maps/).
 ...
 ```
 */
@interface MLNSymbolStyleAnnotation : MLNStyleAnnotation
...
/**
 ...
 To add an image to the map style's sprite, use the `-[MLNStyle setImage:forName:]` method 
 within the [Mapbox Maps SDK for iOS](https://docs.mapbox.com/ios/api/maps/).
 
 @param coordinate The coordinate at which the symbol style annotation's anchor should be placed.
 @param iconImageName The name of the image within the `MLNMapStyle`'s 
...
/**
 The name of the image within an `MLNMapStyle`'s [sprite](https://docs.mapbox.com/help/glossary/sprite/) 
...
/**
 ...
 as specified by `MLNIconAnchor`. Requires `iconImageName`. Defaults to `center`.
 ...
 */
@property (nonatomic, assign) MLNIconAnchor iconAnchor;
...
/**
 ...
 as specified by `MLNTextTransform`. Requires `text`. Defaults to `none`.
 ...
 */
@property (nonatomic, assign) MLNTextTransform textTransform;

/**
 The text justification or "alignment" of the symbol style annotation's text, as 
 specified by `MLNTextJustification`. Requires `text`. Defaults to `center`.
 ...
 */
@property (nonatomic, assign) MLNTextJustification textJustification;

/**
 The placement of the symbol style annotation's text relative to its anchor, as specified
 by `MLNTextAnchor`. Requires `text`. Defaults to `center`.
 ...
 */
@property (nonatomic, assign) MLNTextAnchor textAnchor;
