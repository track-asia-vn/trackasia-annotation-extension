...
/**
 An `MLNLineStyleAnnotation` is a type of style layer annotation that
 ...
 style annotation object. Then, use `-[MLNLineAnnotationController add:]` to add the annotation
 ...
 ```
 */
@interface MLNLineStyleAnnotation : MLNStyleAnnotation
...
/**
 The display of the line style annotation when joining with other lines, as specified by `MLNLineJoin`. 
 Defaults to `miter`.
 ...
 */
@property (nonatomic, assign) MLNLineJoin lineJoin;
...
/**
 ...
 use the `-[MLNStyle setImage:forName:]` method within the [Mapbox Maps SDK for iOS](https://docs.mapbox.com/ios/api/maps/).
