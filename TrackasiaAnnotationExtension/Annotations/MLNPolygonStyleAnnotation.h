...
/**
 An `MLNPolygonStyleAnnotation` is a type of style layer annotation that
 ...
 style annotation object. Then, use `-[MLNPolygonAnnotationController add:]` to add the annotation
 ...
 ```
 */
@interface MLNPolygonStyleAnnotation : MLNStyleAnnotation
...
/**
 ...
 @param coordinates An array of coordinates representing the polygon shape.
 @param interiorPolygons An array of `MLNPolygonFeature`s  that represent any holes the 
    polygon may contain.
 @return An initialized polygon style annotation with a defined fill color.
 */
