...
/**
 An `MLNCircleStyleAnnotation` is a type of style layer annotation
 ...
 style annotation object. Then, use `-[MLNCircleAnnotationController add:]` to add the annotation
 ...
 ```
 */
@interface MLNCircleStyleAnnotation : MLNStyleAnnotation
